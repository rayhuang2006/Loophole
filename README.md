...
**最快的方式是[線上玩二十一關](https://rayhuang2006.github.io/Loophole/)** —— 不用裝任何東西，
...
./loophole --version                          # loophole 1.7.0  (wish 1.0, genie 1.0)
```
...
- **v1.7.0** 教學重寫成二十一關（前五關只照做不出題）、語法高亮、`--json` 加上 `wrote` 和 `registers`。**done**
